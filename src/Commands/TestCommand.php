...
namespace MillCloud\LaravelIgnition\Commands;
    ...
    protected function sendTestException(): void
    {
        ...
        try {
            ...
            $this->table([], [
                ...
                ['PHP', phpversion()],
                ['Laravel', app()->version()],
                ['millcloud/ignition', InstalledVersions::getVersion('millcloud/ignition')],
                ['millcloud/laravel-ignition', InstalledVersions::getVersion('millcloud/laravel-ignition')],
                ['millcloud/flare-client-php', InstalledVersions::getVersion('millcloud/flare-client-php')],
