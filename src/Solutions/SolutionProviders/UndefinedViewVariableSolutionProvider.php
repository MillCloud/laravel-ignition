...
use MillCloud\LaravelIgnition\Solutions\MakeViewVariableOptionalSolution;
use MillCloud\LaravelIgnition\Solutions\SuggestCorrectVariableNameSolution;
use Throwable;
...
class UndefinedViewVariableSolutionProvider implements HasSolutionsForThrowable
{
    ...
    /**
     * @param \MillCloud\LaravelIgnition\Exceptions\ViewException $throwable
